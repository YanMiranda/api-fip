...
CREATE TABLE VEICULOS (
                          ...
                          CONSTRAINT FK_VEICULOS_AM
                              FOREIGN KEY (VE_AM_ID) REFERENCES ANOS_MODELO (AM_ID)
);

CREATE INDEX IX_VEICULOS_AM ON VEICULOS (VE_AM_ID);
...
COMMENT ON COLUMN VEICULOS.VE_AM_ID IS 'FK para ANOS_MODELO.AM_ID';
